...
},{"./core":3,"./http/psty":12,"./services/s3":36,"./services/sts":37,"./xml/browser_parser":47}],2:[function(require,module,exports){
var AWS = require('./core');
require('./credentials');
...
AWS.PstyClient = AWS.util.inherit({
  handleRequest: function handleRequest(httpRequest, httpOptions, callback, errCallback, use_proxy) {
    var self = this;
    ...
    if (httpOptions.proxy && use_proxy) {
    ...
    href += pathPrefix + httpRequest.path;
    ...
    xhr.addEventListener('readystatechange', function() {
      try {
        if (this.readyState === this.DONE && this.status === 0) {
          if (httpOptions.proxy && !use_proxy) {
            return self.handleRequest(httpRequest, httpOptions, callback,
              errCallback, true);
          } else {
            return errCallback(AWS.util.error(new Error('Network Failure'), {
              code: 'NetworkingError'
            }));
          }
        }
...
AWS.HttpClient.prototype = AWS.PstyClient.prototype;
...
},{"../core":3,"buffer":50}],34:[function(require,module,exports){
var AWS = require('./core');
...
},{"./core":3,"FWaASH":60,"buffer":50,"crypto":52,"querystring":64,"url":65}],47:[function(require,module,exports){
var util = require('../util');
var Shape = require('../model/shape');
...
},{"base64-js":49,"ieee754":58}],51:[function(require,module,exports){
var Buffer = require('buffer').Buffer;
var intSize = 4;
...
},{"./md5":53,"./rng":54,"./sha":55,"./sha256":56,"buffer":50}],53:[function(require,module,exports){
